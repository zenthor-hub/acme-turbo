...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "shadow-xs focus:outline-hidden flex h-9 w-full cursor-pointer items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "outline-hidden data-disabled:pointer-events-none data-disabled:opacity-50 relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm focus:bg-accent focus:text-accent-foreground",
      className,
    )}
    {...props}
  >
