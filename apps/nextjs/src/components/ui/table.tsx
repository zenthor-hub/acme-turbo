...
const TableHead = ({
  ...
  <th
    ref={ref}
    className={cn(
      "not-last:border-r not-last:border-r-gray-300 h-10 px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
...
const TableCell = ({
  ...
  <td
    ref={ref}
    className={cn(
      "not-last:border-r not-last:border-r-gray-300 p-2 align-middle [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
